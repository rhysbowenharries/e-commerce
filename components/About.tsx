...
export default function About({}: Props) {
  return (
    ...
    >
      <h3 className="absoloute top-24 uppercase tracking-[20px] text-gray-500 text-2xl invisible sm:visible">
        About
      </h3>
      ...
      <motion.img
        ...
        className="mb-20 md:mb-0 flex-shrink-0 w-56 h-56 rounded-full object-cover md:rounded-lg p-5 sm:p-0 md:w-64 md:h-95 xl:w-[500px] xl:h-[600px]"
      />
